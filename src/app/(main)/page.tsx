...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 animate-in fade-in-0">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl md:text-4xl font-headline tracking-tight">Your Events</h1>
        <CreateEventDialog />
      </div>
      ...
      {events.length > 0 ? (
        ...
        <div className="text-center py-10 md:py-20 border-2 border-dashed rounded-lg">
